...
namespace CastleInvasion
{
    public class MoneyFeedbackHandler : MonoBehaviour
    {
        ...
        {
            MoneyFeedback moneyFeedback = ObjectPooler.Instance.SpawnFromPool(Enums.PoolStamp.MoneyFeedback, doorTransform.position + (Vector3.up * 1.75f) - (doorTransform.forward * 0.5f), Quaternion.identity).GetComponent<MoneyFeedback>();
